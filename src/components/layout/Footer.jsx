    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container-wrapper">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-semibold mb-4">URBIS</h3>
            <p className="text-gray-300">
              Soluções urbanísticas inteligentes para cidades mais humanas, sustentáveis e tecnológicas.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-300">
              <p>Rua das Urbanistas, 123</p>
              <p>São Paulo, SP - Brasil</p>
              <p>contato@urbis.com.br</p>
              <p>+55 (11) 95555-7777</p>
            </div>
          </div>
        </div>
